...
// import { MapPin, Briefcase, Clock, Heart, Bookmark, ChevronDown, Code, Palette, BarChart3, Users, TrendingUp, Zap } from 'lucide-react'
...
//   const locations = ['New York, USA', 'Los Angeles, USA', 'Texas, USA', 'Houston, USA', 'Austin, USA', 'San Francisco, USA']
//   const categories = ['Hotels & Tourism', 'Media', 'Construction', 'Design', 'Technology']
...
//       const matchesCategory = !selectedCategory || job.tags[0] === selectedCategory
//       const matchesType = !selectedType || job.tags[1] === selectedType
...
//                             <IconComponent className="w-6 h-6 text-teal-600" strokeWidth={2.5} />
//                           </div>
